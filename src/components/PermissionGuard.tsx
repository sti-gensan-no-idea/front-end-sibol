...
export const usePermissions = () => {
  ...
  return {
    ...
    canViewAnalytics:
      checkPermission("view_analytics") || checkPermission("system_analytics"),
...
export const ClientOnly: React.FC<{
  ...
  <PermissionGuard fallback={fallback} role="client">
    {children}
  </PermissionGuard>
);

export const AgentOnly: React.FC<{
  children: React.ReactNode;
  fallback?: React.ReactNode;
}> = ({ children, fallback }) => (
  <PermissionGuard fallback={fallback} role="agent">
    {children}
  </PermissionGuard>
);
...
export const BrokerOnly: React.FC<{
  ...
  <PermissionGuard fallback={fallback} role="broker">
    {children}
  </PermissionGuard>
);
...
export const DeveloperOnly: React.FC<{
  ...
  <PermissionGuard fallback={fallback} role="developer">
    {children}
  </PermissionGuard>
);
...
export const AdminOnly: React.FC<{
  ...
  <PermissionGuard fallback={fallback} role="admin">
    {children}
  </PermissionGuard>
);
...
export const StaffOnly: React.FC<{
  ...
  <PermissionGuard
    fallback={fallback}
    roles={["agent", "broker", "developer", "admin"]}
  >
    {children}
  </PermissionGuard>
);

export const ManagementOnly: React.FC<{
  children: React.ReactNode;
  fallback?: React.ReactNode;
}> = ({ children, fallback }) => (
  <PermissionGuard fallback={fallback} roles={["broker", "developer", "admin"]}>
    {children}
  </PermissionGuard>
);
 ...
 */
export const CanUploadProperties: React.FC<{
  children: React.ReactNode;
  fallback?: React.ReactNode;
}> = ({ children, fallback }) => (
  <PermissionGuard fallback={fallback} permission="upload_properties">
    {children}
  </PermissionGuard>
);

export const CanManageTeams: React.FC<{
  children: React.ReactNode;
  fallback?: React.ReactNode;
}> = ({ children, fallback }) => (
  <PermissionGuard fallback={fallback} permission="manage_teams">
    {children}
  </PermissionGuard>
);

export const CanAccessCRM: React.FC<{
  children: React.ReactNode;
  fallback?: React.ReactNode;
}> = ({ children, fallback }) => (
  <PermissionGuard fallback={fallback} permission="access_crm">
    {children}
  </PermissionGuard>
);
...
export const CanViewAnalytics: React.FC<{
  ...
  <PermissionGuard fallback={fallback} permission="system_analytics">
    {children}
  </PermissionGuard>
);
...
export const CanManageUsers: React.FC<{
  ...
  <PermissionGuard fallback={fallback} permission="manage_users">
    {children}
  </PermissionGuard>
);
