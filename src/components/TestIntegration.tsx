...
const TestIntegration: React.FC = () => {
  ...
  const { properties, loading: propertiesLoading } = useProperties({ autoFetch: false });
    ...
    <div className="p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 border rounded bg-green-50">
          <h2 className="text-lg font-semibold text-green-800">✅ Core Integration Working!</h2>
          <p className="text-green-700">The basic API integration is functioning correctly.</p>
        </div>
      </div>
    </div>
  );
