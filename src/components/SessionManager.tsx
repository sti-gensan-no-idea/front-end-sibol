...
export const SessionManager: React.FC = () => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50">
      <Card
        className={`w-80 ${showWarning ? "border-orange-500 bg-orange-50" : "border-gray-200"}`}
      >
        <CardBody className="p-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${checkSession() ? "bg-green-500" : "bg-red-500"}`}
              />
            ...
            <div className="text-right">
              <p
                className={`text-xs font-medium ${showWarning ? "text-orange-600" : "text-gray-600"}`}
              >
